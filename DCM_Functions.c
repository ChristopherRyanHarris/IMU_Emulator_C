...
/*************************************************
** Set_Sensor_Fusion
** Similar to Reset_Sensor_Fusion, except we do n void ot
...
void DCM_Filter( void )
{
  ...
  //fprintf(stdout,"accel:%f accel:%f accel:%f\t",g_sensor_state.accel[0],g_sensor_state.accel[1],g_sensor_state.accel[2]);
  //fprintf(stdout,"gyro:%f gyro:%f gyro:%f\n",g_sensor_state.gyro[0],g_sensor_state.gyro[1],g_sensor_state.gyro[2]);
